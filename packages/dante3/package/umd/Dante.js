(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@tiptap/react'), require('@tiptap/starter-kit'), require('@tiptap/extension-link'), require('@tiptap/extension-text-style'), require('@tiptap/extension-code-block-lowlight'), require('@tiptap/extension-focus'), require('@tiptap/extension-ordered-list'), require('@tiptap/extension-list-item'), require('@tiptap/extension-task-list'), require('@tiptap/extension-task-item'), require('@emotion/react'), require('@tiptap/core'), require('@emotion/styled'), require('polished'), require('axios'), require('prop-types'), require('medium-zoom'), require('use-countdown-timer'), require('prosemirror-state'), require('tippy.js'), require('react-colorful'), require('prosemirror-view'), require('lowlight')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@tiptap/react', '@tiptap/starter-kit', '@tiptap/extension-link', '@tiptap/extension-text-style', '@tiptap/extension-code-block-lowlight', '@tiptap/extension-focus', '@tiptap/extension-ordered-list', '@tiptap/extension-list-item', '@tiptap/extension-task-list', '@tiptap/extension-task-item', '@emotion/react', '@tiptap/core', '@emotion/styled', 'polished', 'axios', 'prop-types', 'medium-zoom', 'use-countdown-timer', 'prosemirror-state', 'tippy.js', 'react-colorful', 'prosemirror-view', 'lowlight'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Dante = {}, global.React, global.react, global.StarterKit, global.Link, global.TextStyle, global.CodeBlockLowlight, global.Focus, global.OrderedList, global.ListItem, global.TaskList, global.TaskItem, global.react$1, global.core, global.styled, global.polished, global.axios, global.PropTypes, global.mediumZoom, global.useCountdownTimer, global.prosemirrorState, global.tippy, global.reactColorful, global.prosemirrorView, global.lowlight));
}(this, (function (exports, React, react, StarterKit, Link, TextStyle, CodeBlockLowlight, Focus, OrderedList, ListItem, TaskList, TaskItem, react$1, core, styled, polished, axios, PropTypes, mediumZoom, useCountdownTimer, prosemirrorState, tippy, reactColorful, prosemirrorView, lowlight) { 'use strict';
    ...
    var Focus__default = /*#__PURE__*/_interopDefaultLegacy(Focus);
    ...
    var TaskList__default = /*#__PURE__*/_interopDefaultLegacy(TaskList);
    var TaskItem__default = /*#__PURE__*/_interopDefaultLegacy(TaskItem);
    var styled__default = /*#__PURE__*/_interopDefaultLegacy(styled);
    var axios__default = /*#__PURE__*/_interopDefaultLegacy(axios);
    var PropTypes__default = /*#__PURE__*/_interopDefaultLegacy(PropTypes);
    var mediumZoom__default = /*#__PURE__*/_interopDefaultLegacy(mediumZoom);
    var tippy__default = /*#__PURE__*/_interopDefaultLegacy(tippy);
    var lowlight__default = /*#__PURE__*/_interopDefaultLegacy(lowlight);
    ...
    ***************************************************************************** */
    ...
    var dante_font_family_sans_serif$1 = "ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,Noto Sans,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"; // const dante_font_family_sans = `'jaf-bernino-sans', 'Playfair Display', 'Open Sans', "Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Geneva, Verdana, sans_serif;`;
    ...
    function extensionFactory(options) {
      return core.Node.create({
        ...
        renderHTML: function renderHTML(_ref10) {
          ...
          return [options.tag, react.mergeAttributes(attributes)];
        },
        addNodeView: function addNodeView() {
          return react.ReactNodeViewRenderer(options.component);
        },
        addInputRules: function addInputRules() {
          ...
          return options.addInputRules().map(function (rule) {
            return core.nodeInputRule(rule, _this.type);
          });
        }
      });
    }
    ...
    var StyleWrapper$5 = styled__default['default'](react.NodeViewWrapper)(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral(["\n  .content {\n    background: ", ";\n    padding: 1.2em;\n    padding-top: 0.5em;\n    padding-bottom: 0.5em;\n\n    select,\n    .language {\n      float: right;\n      color: ", ";\n      background-color: ", ";\n    }\n\n    margin-bottom: 10px;\n    margin-top: 10px;\n  }\n\n  /*\n  Qt Creator dark color scheme\n  */\n\n  .hljs {\n    color: ", ";\n    background: ", ";\n  }\n\n  .hljs-strong,\n  .hljs-emphasis {\n    color: ", ";\n  }\n\n  .hljs-bullet,\n  .hljs-quote,\n  .hljs-number,\n  .hljs-regexp,\n  .hljs-literal {\n    color: ", ";\n  }\n\n  .hljs-code .hljs-selector-class {\n    color: ", ";\n  }\n\n  .hljs-emphasis,\n  .hljs-stronge,\n  .hljs-type {\n    font-style: italic;\n  }\n\n  .hljs-keyword,\n  .hljs-selector-tag,\n  .hljs-function,\n  .hljs-section,\n  .hljs-symbol,\n  .hljs-name {\n    color: ", ";\n  }\n\n  .hljs-subst,\n  .hljs-tag,\n  .hljs-title {\n    color: ", ";\n  }\n\n  .hljs-attribute {\n    color: ", ";\n  }\n\n  .hljs-variable,\n  .hljs-params,\n  .hljs-title.class_,\n  .hljs-class .hljs-title {\n    color: ", ";\n  }\n\n  .hljs-string,\n  .hljs-selector-id,\n  .hljs-selector-attr,\n  .hljs-selector-pseudo,\n  .hljs-type,\n  .hljs-built_in,\n  .hljs-template-tag,\n  .hljs-template-variable,\n  .hljs-addition,\n  .hljs-link {\n    color: ", ";\n  }\n\n  .hljs-comment,\n  .hljs-meta,\n  .hljs-deletion {\n    color: ", ";\n  }\n"])), function (props) {
    ...
    function Code(props) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper$5, {
        selected: props.selected
      }, /*#__PURE__*/React__default['default'].createElement("div", {
        className: "content"
      }, props.editor.isEditable && /*#__PURE__*/React__default['default'].createElement("select", {
        contentEditable: false,
        onChange: changeLanguage,
        value: language()
      }, /*#__PURE__*/React__default['default'].createElement("option", {
        value: "null"
      }, "auto"), /*#__PURE__*/React__default['default'].createElement("option", {
        disabled: true
      ...
      })), !props.editor.isEditable && /*#__PURE__*/React__default['default'].createElement("span", {
        className: "language"
      }, language()), /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, {
        as: "pre",
        className: "hljs"
      })));
    }
    ...
    var EditorContainer = styled__default['default'].div(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  //@import url(\"//fonts.googleapis.com/css?family=Merriweather:400,700,400italic,700italic|Open+Sans:400,300,700,800\");\n\n  //@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,600;1,800&display=swap');\n\n  font-family: ", " !important;\n  letter-spacing: 0.01rem;\n  font-weight: 400;\n  font-style: normal;\n  font-size: ", ";\n  line-height: ", ";\n  color: ", ";\n  background-color: ", ";\n\n  text-rendering: optimizeLegibility;\n\n  .ProseMirror {\n    &:focus-visible {\n      outline-color: transparent;\n      outline-width: 0px;\n    }\n  }\n\n  @media (max-width: 500px) {\n    font-size: ", ";\n    line-height: ", ";\n  }\n\n  .public-DraftEditorPlaceholder-root {\n    color: ", ";\n    position: absolute;\n    z-index: 0;\n    font-size: ", ";\n    background-color: transparent;\n  }\n\n  .graf--h2,\n  .graf--h3,\n  .graf--h4,\n  .graf--h5,\n  .graf--h6,\n  .graf--h7,\n  .postList,\n  .graf--hr,\n  .graf--figure,\n  .graf--blockquote,\n  .graf--pullquote,\n  .graf--p,\n  .graf--pre {\n    margin: 0;\n    //position:relative;\n  }\n\n  li {\n    counter-reset: ol0;\n    margin-left: 1.5em;\n  }\n\n  ul {\n    list-style-type: disc;\n    position: relative;\n  }\n\n  ol {\n    list-style-type: decimal;\n    position: relative;\n  }\n\n  li {\n    .graf--p {\n      margin: 0px;\n    }\n  }\n\n  ul[data-type=\"taskList\"] {\n    list-style: none;\n    padding: 0;\n\n    li {\n      display: flex;\n      align-items: center;\n\n      > label {\n        flex: 0 0 auto;\n        margin-right: 0.5rem;\n      }\n    }\n  }\n\n  .graf--code {\n    position: relative;\n    overflow: visible;\n\n    background: ", ";\n    font-family: ", ";\n    font-size: ", ";\n    margin-bottom: 20px;\n    padding: 20px;\n    white-space: pre-wrap;\n    color: ", ";\n\n    .dante-code-syntax {\n      color: ", ";\n      position: absolute;\n      top: 4px;\n      right: 4px;\n      width: 165px;\n    }\n  }\n\n  .graf--pre {\n    background: #000 !important;\n    font-family: ", ";\n    font-size: 16px;\n    margin-bottom: 20px;\n    padding: 20px;\n    white-space: pre-wrap;\n    color: #fff !important;\n  }\n\n  .postList {\n    margin-bottom: 30px;\n  }\n\n  .graf--p {\n    code {\n      font-family: ", ";\n      background-color: #faf594;\n      color: ", ";\n      -webkit-box-decoration-break: clone;\n      box-decoration-break: clone;\n      font-weight: 200;\n      padding: 3px;\n    }\n  }\n\n  .graf--p,\n  .graf--blockquote,\n  .graf--pullquote {\n    margin-bottom: 30px;\n  }\n\n  .graf--code {\n    line-height: 1em;\n  }\n\n  .graf--p.dante--spinner {\n    position: relative;\n  }\n\n  .graf--hr {\n    hr {\n      border: 1px solid #ccc;\n      margin: 26px;\n    }\n  }\n\n  .public-DraftStyleDefault-pre {\n    overflow: inherit;\n  }\n\n  h1.graf--h {\n    font-family: ", ";\n    font-size: ", ";\n    font-style: normal;\n    font-weight: 800;\n    letter-spacing: -0.04em;\n    line-height: 1;\n    margin-bottom: 0.4em;\n    margin-left: -3px;\n    margin-top: 40px;\n    padding-top: 0;\n  }\n\n  h2.graf--h {\n    font-family: ", ";\n    font-size: ", ";\n    font-style: normal;\n    font-weight: 600;\n    letter-spacing: -0.04em;\n    line-height: 1;\n    margin-bottom: 0.4em;\n    margin-left: -3px;\n    margin-top: 40px;\n    padding-top: 0;\n  }\n\n  h3.graf--h {\n    font-family: ", ";\n    letter-spacing: -0.02em;\n    font-weight: 700;\n    font-style: normal;\n    font-size: ", ";\n    margin-left: -1.8px;\n    line-height: 1.2;\n    margin-top: 40px;\n    margin-bottom: 0.7em;\n    font-weight: 300;\n  }\n\n  h4.graf--h {\n    font-family: ", ";\n    letter-spacing: -0.02em;\n    font-weight: 300;\n    font-style: normal;\n    font-size: ", ";\n    margin-left: -1.5px;\n    line-height: 1.2;\n    color: ", ";\n    margin-top: 40px;\n    margin-bottom: 0.6em;\n  }\n\n  @media (max-width: 500px) {\n    h1.graf--h {\n      margin-top: 10px;\n      font-size: ", ";\n      line-height: ", ";\n    }\n\n    h2.graf--h {\n      margin-top: 10px;\n      font-size: ", ";\n      line-height: ", ";\n    }\n\n    h3.graf--h {\n      margin-top: 10px;\n      font-size: ", ";\n      line-height: ", ";\n    }\n  }\n\n  @media (max-width: 500px) {\n    .graf--h2 {\n      font-size: 2.6em;\n    }\n    .graf--h3 {\n      font-size: 1.6em;\n    }\n    .graf--h4 {\n      font-size: 1.4em;\n    }\n  }\n\n  .section--first .graf--h2.graf--first,\n  .section--first .graf--h3.graf--first,\n  .section--first .graf--h4.graf--first {\n    margin-top: 0;\n    padding-top: 0;\n  }\n\n  h2.graf--h + h2.graf--h {\n    margin-top: -8px;\n  }\n\n  h2.graf--h + h3.graf--h,\n  h2.graf--h + h4.graf--h {\n    margin-top: -6px;\n  }\n\n  h3.graf--h3 + h4.graf--h4,\n  h4.graf--h4 + h2.graf--h2 {\n    margin-top: 2px;\n  }\n\n  h3.graf--h3 + h4.graf--h4,\n  h4.graf--h4 + h3.graf--h3 {\n    margin-top: -2px;\n  }\n\n  h2.graf--h2 + .postList,\n  h3.graf--h3 + .postList,\n  h4.graf--h4 + .postList {\n    margin-top: 10px;\n  }\n\n  h2.graf--h + .graf--p.graf--empty,\n  h3.graf--h + .graf--p.graf--empty,\n  h4.graf--h + .graf--p.graf--empty {\n    margin-bottom: -7px;\n    margin-top: -7px;\n  }\n\n  h2.graf--h + .graf--p.graf--empty + h1.graf--h,\n  h3.graf--h + .graf--p.graf--empty + h1.graf--h,\n  h4.graf--h + .graf--p.graf--empty + h1.graf--h {\n    margin-top: -5px;\n  }\n\n  h2.graf--h + .graf--p.graf--empty + h3.graf--h,\n  h3.graf--h + .graf--p.graf--empty + h3.graf--h,\n  h4.graf--h + .graf--p.graf--empty + h3.graf--h,\n  h2.graf--h + .graf--p.graf--empty + h4.graf--h,\n  h3.graf--h + .graf--p.graf--empty + h4.graf--h,\n  h4.graf--h + .graf--p.graf--empty + h4.graf--h {\n    margin-top: -8px;\n  }\n\n  .graf--blockquote,\n  blockquote {\n    font-family: ", ";\n    border-left: 3px solid rgba(0, 0, 0, 0.8);\n\n    font-style: italic;\n    font-weight: 400;\n    letter-spacing: 0.16px;\n    letter-spacing: 0.02rem;\n    margin-left: -12px;\n    padding-left: 15px;\n    margin-bottom: 25px;\n    //font-size: 1.2em;\n    line-height: 1.5em;\n    margin-top: 20px;\n  }\n  .graf--blockquote + .graf--blockquote {\n    margin-top: -30px;\n    padding-top: 30px;\n  }\n\n  .graf--pullquote {\n    line-height: 1.4;\n    text-align: center;\n    font-size: 3.2em;\n    margin: 48px -160px;\n    border: none;\n    padding: 0;\n    font-family: ", ";\n    letter-spacing: 0.01rem;\n    font-weight: 400;\n    font-style: italic;\n    -webkit-transition: margin 100ms;\n    transition: margin 100ms;\n  }\n\n  .graf--pre + .graf--pre {\n    margin-top: -20px;\n  }\n\n  .graf--figure {\n    box-sizing: border-box;\n    clear: both;\n    margin-bottom: 30px;\n    outline: medium none;\n    position: relative;\n\n    &.is-mediaFocused .graf-image,\n    &.is-mediaFocused iframe {\n      box-shadow: 0 0 0 3px #57ad68;\n    }\n  }\n\n  .graf--mixtapeEmbed {\n    a {\n      text-decoration: none;\n    }\n    &.is-mediaFocused {\n      box-shadow: 0 0 0 1px #57ad68;\n    }\n\n    .graf--media-embed-close {\n      position: absolute;\n      top: 1px;\n      display: inline-block;\n      font-size: 2em;\n      width: 20px;\n      right: 10px;\n      text-shadow: 0px 0px 0px white;\n    }\n\n    border-color: ", ";\n    border-radius: 5px;\n    border-style: solid;\n    border-width: 1px;\n    box-sizing: border-box;\n    //color: rgba(0, 0, 0, 0.6);\n    font-family: ", ";\n    font-size: 12px;\n    font-style: normal;\n    font-weight: 300;\n    letter-spacing: -0.02em;\n    margin-bottom: 40px;\n    margin-top: 40px;\n    max-height: 310px;\n    //max-width: 700px;\n    overflow: hidden;\n    padding: 30px;\n    position: relative;\n\n    .is-postEditMode iframe {\n      border: 3px solid rgba(255, 255, 255, 0);\n    }\n\n    .mixtapeImage {\n      background-position: center center;\n      background-repeat: no-repeat;\n      background-size: cover;\n      float: right;\n      height: 310px;\n      margin: -30px -30px 0 25px;\n      width: 310px;\n    }\n\n    .mixtapeImage--empty {\n      height: 0;\n      width: 0;\n    }\n\n    .markup--mixtapeEmbed-strong {\n      //color: #000;\n      display: block;\n      font-family: $dante-font-family-sans;\n      font-size: 30px;\n      font-style: normal;\n      font-weight: 300;\n      letter-spacing: -0.02em;\n      line-height: 1.2;\n      margin-bottom: 0px;\n    }\n\n    .markup--mixtapeEmbed-em {\n      display: block;\n      font-size: 16px;\n      font-style: normal;\n      margin-bottom: 10px;\n      max-height: 120px;\n      overflow: hidden;\n    }\n  }\n\n  .graf--h4 + .graf--figure,\n  .graf--h3 + .graf--figure,\n  .graf--h2 + .graf--figure {\n    margin-top: 15px;\n  }\n\n  .graf--first {\n    margin-top: 0;\n    padding-top: 0;\n  }\n\n  /*.graf--empty {\n    margin-bottom: -7px;\n    margin-top: -7px;\n  }*/\n\n  p[data-align=\"center\"],\n  .graf--h2[data-align=\"center\"],\n  .graf--h3[data-align=\"center\"],\n  .graf--h4[data-align=\"center\"],\n  .graf--blockquote[data-align=\"center\"] {\n    text-align: center;\n  }\n\n  .markup--anchor,\n  .graf--sectionCaption {\n    cursor: text;\n  }\n  .markup--anchor {\n    text-decoration: underline;\n    color: inherit;\n  }\n\n  .graf--divider {\n    margin-bottom: 30px;\n  }\n\n  .graf--divider span {\n    text-align: center;\n    width: 100%;\n    display: block;\n  }\n\n  .graf--divider span:before {\n    line-height: 1;\n    user-select: none;\n    font-weight: 400;\n    font-size: 25px;\n    letter-spacing: 18px;\n    content: \"...\";\n    display: inline-block;\n    margin-left: 0.6em;\n    position: relative;\n    color: ", ";\n    top: -3px;\n  }\n\n  .graf--layoutOutsetLeft {\n    margin-left: -160px;\n  }\n\n  .graf--layoutFillWidth {\n    margin-left: -200px;\n    margin-right: -200px;\n  }\n\n  .graf--layoutOutsetLeft {\n    width: 75%;\n  }\n  .graf--layoutInsetLeft,\n  .graf--layoutOutsetLeft {\n    float: left;\n    margin-right: 30px;\n    padding-top: 10px;\n    padding-bottom: 10px;\n  }\n\n  .imageCaption {\n    //top: 0;\n    text-align: center;\n    margin-top: 0;\n    font-family: ", ";\n    letter-spacing: 0;\n    font-weight: 400;\n    font-size: 13px;\n    line-height: 1.4;\n    color: ", ";\n    outline: 0;\n    z-index: 300;\n    margin-top: 10px;\n    //position: relative;\n\n    .danteDefaultPlaceholder {\n      margin-bottom: -18px !important;\n      display: block;\n    }\n  }\n\n  // FIGURE WRAPPER\n\n  .aspectRatioPlaceholder {\n    margin: 0 auto;\n    position: relative;\n    width: 100%;\n  }\n\n  .graf-image:before,\n  .iframeContainer:before {\n    .is-postEditMode & {\n      bottom: 0;\n      content: \"\";\n      left: 0;\n      position: absolute;\n      right: 0;\n      top: 0;\n      z-index: 500;\n    }\n  }\n\n  .aspectRatioPlaceholder.is-locked .graf-image,\n  .aspectRatioPlaceholder.is-locked .graf-imageAnchor {\n    height: 100%;\n    left: 0;\n    position: absolute;\n    top: 0;\n    width: 100%;\n  }\n\n  .graf-image,\n  .graf-imageAnchor,\n  .iframeContainer > iframe,\n  .iframeContainer {\n    box-sizing: border-box;\n    display: block;\n    margin: auto;\n    max-width: 100%;\n  }\n\n  .aspectRatioPlaceholder {\n    .image-upoader-loader {\n      position: absolute;\n      bottom: 0px;\n      left: 0%;\n      background-color: #fff;\n      width: 100%;\n      /* height: 3px; */\n      text-align: center;\n      top: 0px;\n      vertical-align: text-bottom;\n      opacity: 0.7;\n      p {\n        line-height: 5px;\n        /* font-weight: 700; */\n        /* text-transform: uppercase; */\n        font-size: 14px;\n        margin-top: 49%;\n      }\n    }\n  }\n\n  div[contenteditable=\"false\"] {\n    .danteDefaultPlaceholder {\n      display: none;\n    }\n  }\n\n  div[contenteditable=\"false\"] {\n    a.markup--anchor {\n      cursor: pointer;\n    }\n  }\n\n  figcaption .public-DraftStyleDefault-block {\n    text-align: center;\n  }\n\n  @media (max-width: 1200px) {\n    .imageCaption,\n    .postField--outsetCenterImage > .imageCaption {\n      position: relative;\n      width: 100%;\n      text-align: center;\n      left: 0;\n      margin-top: 10px;\n    }\n  }\n\n  figure.graf--layoutOutsetLeft {\n    .imageCaption,\n    .postField--outsetCenterImage > .imageCaption {\n      position: relative;\n      width: 100%;\n      text-align: center;\n      left: 0;\n      margin-top: 10px;\n    }\n  }\n\n  figure.is-defaultValue .imageCaption,\n  .graf--sectionCaption.is-defaultValue {\n    display: none;\n  }\n\n  .graf--figure.is-mediaFocused .imageCaption,\n  .graf--figure.is-defaultValue.is-selected .imageCaption,\n  section.is-mediaFocused .graf--sectionCaption,\n  .graf--sectionCaption.is-defaultValue.is-selected {\n    display: block;\n  }\n\n  .ProseMirror .empty-node::before {\n    position: absolute;\n    color: #aaa;\n    cursor: text;\n  }\n\n  .ProseMirror .empty-node:hover::before {\n    color: #777;\n  }\n\n  .ProseMirror h1.empty-node::before {\n    content: \"Title\";\n  }\n\n  /*.ProseMirror p.empty-node:first-of-type::before {\n    content: 'Contents';\n  }*/\n\n  /* Placeholder (at the top) */\n  .ProseMirror p.is-editor-empty:first-of-type::before {\n    content: attr(data-placeholder);\n    float: left;\n    color: #ced4da;\n    pointer-events: none;\n    height: 0;\n  }\n\n  .ProseMirror .is-node-empty:first-of-type::before {\n    content: attr(data-placeholder);\n    float: left;\n    color: #ced4da;\n    pointer-events: none;\n    height: 0;\n  }\n\n  /* Give a remote user a caret */\n  .collaboration-cursor__caret {\n    position: relative;\n    margin-left: -1px;\n    margin-right: -1px;\n    border-left: 1px solid #0d0d0d;\n    border-right: 1px solid #0d0d0d;\n    word-break: normal;\n    pointer-events: none;\n  }\n\n  /* Render the username above the caret */\n  .collaboration-cursor__label {\n    position: absolute;\n    top: -1.4em;\n    left: -1px;\n    font-size: 12px;\n    font-style: normal;\n    font-weight: 600;\n    line-height: normal;\n    user-select: none;\n    color: #0d0d0d;\n    padding: 0.1rem 0.3rem;\n    border-radius: 3px 3px 3px 0;\n    white-space: nowrap;\n  }\n"])), function (props) {
      ...
      return polished.lighten(0.1, props.theme.dante_text_color);
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, "* 0.9"));
    }, function (props) {
      ...
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 3.2"));
    }, function (props) {
      return props.theme.dante_font_family_sans;
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 2"));
    }, function (props) {
      return props.theme.dante_font_family_sans;
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 1.3"));
    }, function (props) {
      return props.theme.dante_font_family_sans;
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 1.2"));
    }, function (props) {
      return polished.lighten(0.3, props.theme.dante_text_color);
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 1.6"));
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_line_height, " * 0.6"));
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_font_size, " * 1.2"));
    }, function (props) {
      return polished.math("".concat(props.theme.dante_editor_line_height, " * 0.6"));
    ...
    styled__default['default'].div(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  position: fixed;\n  padding: 20px;\n  height: 100vh;\n  background-color: #ccc;\n  top: 0px;\n  right: 0px;\n  width: 200px;\n  font-size: 0.8em;\n  .close {\n    width: 20px;\n    heigth: 20px;\n  }\n  .log-wrapper {\n    overflow-y: auto;\n    height: 100vh;\n  }\n"])));

    var AddButton = React__default['default'].forwardRef(function (props, ref) {
        var display = props.display, position = props.position, widgets = props.widgets, editor = props.editor, fixed = props.fixed;
        var _a = React__default['default'].useState(false), scaled = _a[0], setScaled = _a[1];
        var _b = React__default['default'].useState(fixed ? "100%" : "0px"), scaledWidth = _b[0], setScaledWidth = _b[1];
        var fileInput = React__default['default'].useRef(null);
        ...
        return (React__default['default'].createElement(InlinetooltipWrapper, { ref: ref, className: "inlineTooltip " + activeClass() + " " + scaledClass(), style: position },
            !fixed && (React__default['default'].createElement("button", { type: "button", className: "inlineTooltip-button control", title: "Close Menu", "data-action": "inline-menu", onClick: _toggleScaled }, add())),
            React__default['default'].createElement("div", { className: "inlineTooltip-menu " + (fixed ? "inlineTooltip-menu-fixed" : ""), style: { width: "" + (fixed ? "-1" : scaledWidth) } },
                getItems().map(function (item, i) {
                    return (React__default['default'].createElement(InlineTooltipItem, { title: "", item: item, key: i, clickHandler: clickHandler }));
                }),
                React__default['default'].createElement("input", { type: "file", accept: "image/*", style: { display: "none" }, ref: fileInput, multiple: true, onChange: handleFileInput }))));
    });
    ...
    function ImageTooltip(_ref) {
      ...
      var image_popover = React__default['default'].useRef(null);
      React__default['default'].useEffect(function () {//getPosition()
      }, []);
      ...
      return /*#__PURE__*/React__default['default'].createElement(AnchorStyle, {
        ...
        return /*#__PURE__*/React__default['default'].createElement("li", {
          key: "menu-".concat(item.type),
          className: "dante-menu-button align-center",
          onMouseDown: function onMouseDown(e) {
            return directionClick(e, item);
          }
    ...
    var BubbleMenuView = /** @class */ (function () {
        ...
        BubbleMenuView.prototype.createTooltip = function (options) {
            ...
            this.tippy = tippy__default['default'](this.view.dom, __assign({ duration: 0, getReferenceClientRect: null, content: this.element, interactive: true, trigger: "manual", placement: "top", hideOnClick: "toggle" }, options));
        };
    ...
    var BubbleMenuPluginKey = new prosemirrorState.PluginKey("menuBubble");
    ...
    function DanteTooltipColor(props) {
      ...
      var _useState3 = React.useState(props.value),
    ...
    function MenuBar(_ref2) {
      ...
      function renderMenu() {
        ...
        return /*#__PURE__*/React__default['default'].createElement(AnchorStyle, {
          ...
          className: "dante-icon"
        }, bold())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
          ...
          className: "dante-icon"
        }, italic())), /*#__PURE__*/React__default['default'].createElement(DanteTooltipColor, {
          styles: {},
          editor: editor,
          ...
          show: show
        }), /*#__PURE__*/React__default['default'].createElement(DanteTooltipLink, {
          ...
          className: "dante-icon"
        }, h1())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
            return editor.chain().focus().toggleHeading({
              level: 2
            }).run();
          ...
          className: "dante-icon"
        }, h2())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
            return editor.chain().focus().toggleHeading({
              level: 3
            }).run();
          ...
          className: "dante-icon"
        }, h3())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
          ...
          className: "dante-icon"
        }, insertunorderedlist())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
          ...
          className: "dante-icon"
        }, insertorderedlist())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
          ...
          className: "dante-icon"
        }, code())), /*#__PURE__*/React__default['default'].createElement("li", {
          onClick: function onClick() {
      ...
      function renderImageTooptip() {
        ...
        if (!editor.isActive("ImageBlock")) return null;
        return /*#__PURE__*/React__default['default'].createElement(ImageTooltip, {
          item: {},
      ...
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, fixed && renderMenu(), !fixed && /*#__PURE__*/React__default['default'].createElement(BubbleMenu, {
        editor: editor
          ...
          props: {
            decorations: function decorations(_ref) {
              ...
              doc.descendants(function (node, pos) {
                ...
                var isEmpty = !node.isLeaf && core.isNodeEmpty(node);
    ...
    var Color = core.Extension.create({
      name: "color",
      defaultOptions: {
        types: ["textStyle"]
      },
    ...
    function Editor(_a) {
        var widgets = _a.widgets, theme = _a.theme, fixed = _a.fixed, content = _a.content, onUpdate = _a.onUpdate, readOnly = _a.readOnly, bodyPlaceholder = _a.bodyPlaceholder, extensions = _a.extensions;
        function basePlugins() {
            return [
                ...
                Color,
                Focus__default['default'],
                Link__default['default'].extend({
                    addNodeView: function () {
                        return react.ReactNodeViewRenderer(Code);
                    },
                ...
                }).configure({ lowlight: lowlight__default['default'] }),
        ...
        return (React__default['default'].createElement(react$1.ThemeProvider, { theme: resolvedTheme },
            React__default['default'].createElement(EditorContainer
            //style={{width: '600px', margin: '0 auto'}}
            , null,
                React__default['default'].createElement("div", null,
                    React__default['default'].createElement(MenuBar, { fixed: fixed, editor: editor }),
                    React__default['default'].createElement(react.EditorContent, { editor: editor }),
                    editor && !fixed && (React__default['default'].createElement(react.FloatingMenu, { editor: editor }, isPopOverEnabledFor() && (React__default['default'].createElement("div", { style: { position: "absolute", top: -15, left: -60 } },
                        React__default['default'].createElement(AddButton
                        //ref={sideBarControls}
                        , { 
                            //ref={sideBarControls}
                            fixed: fixed, position: {}, editor: editor, display: true , widgets: optionalPlugins() }))))),
                    fixed && editor && (React__default['default'].createElement(AddButton
                    //ref={sideBarControls}
                    //position={bounds}
                    , { 
                        //ref={sideBarControls}
    ...
    function ReactMediumZoom(props) {
      ...
      var imgRef = React__default['default'].useRef();
      var zoom = React__default['default'].useRef(mediumZoom__default['default']());
      React__default['default'].useEffect(function () {
        if (!props.editable) {
    ...
    var StyleWrapper$4 = styled__default['default'](react.NodeViewWrapper)(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral([""])));
    function ImageBlock(props) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper$4, {
        selected: props.selected,
        as: "figure",
      ...
      }), /*#__PURE__*/React__default['default'].createElement(ReactMediumZoom, {
        src: imageUrl,
        height: width,
        width: height,
      ...
      })), /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, {
        as: "figcaption",
        className: "imageCaption"
      }, props.node.content.size === 0 && /*#__PURE__*/React__default['default'].createElement("span", {
    ...
    var StyleWrapper$3 = styled__default['default'](react.NodeViewWrapper)(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n  ", "\n"])), function (props) {
    ...
    function EmbedBlock(props) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper$3, {
        selected: props.selected,
        className: "graf graf--mixtapeEmbed ".concat(props.selected ? "is-selected is-mediaFocused" : "")
      }, /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, null, /*#__PURE__*/React__default['default'].createElement("span", {
        contentEditable: false
      }, picture() ? /*#__PURE__*/React__default['default'].createElement("a", {
        target: "_blank",
        ...
        rel: "noreferrer"
      }) : undefined, error ? /*#__PURE__*/React__default['default'].createElement("h2", null, error) : undefined, //!this.props.blockProps.getEditor().props.read_only
      props.editor.isEditable ? /*#__PURE__*/React__default['default'].createElement("a", {
        href: "#",
      ...
      }, embed_data.title), /*#__PURE__*/React__default['default'].createElement("em", {
        className: "markup--em markup--mixtapeEmbed-em"
      }, embed_data.description)), /*#__PURE__*/React__default['default'].createElement("span", {
        contentEditable: false
    ...
    var StyleWrapper$2 = styled__default['default'](react.NodeViewWrapper)(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral([""])));
    function VideoBlock(props) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper$2, {
        as: "figure",
    ...
    */
    ...
    var StyleWrapper$1 = styled__default['default'](react.NodeViewWrapper)(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n  .editable-content {\n    color: ", ";\n    background: ", ";\n    //border-color: ", ";\n    //border-width: 1px;\n    padding: 10px;\n    border-radius: 5px;\n    box-shadow: 0px 1px 3px 0px #9e9e9e54;\n    ::after {\n      content: attr(data-placeholder);\n      color: #b5b4b4;\n      font-size: 0.6em;\n      width: 100%;\n      border-top: 1px solid #c1c1c1;\n      padding-top: 1px;\n    }\n    button {\n      float: right;\n    }\n  }\n"])), function (props) {
      return props.theme.dante_text_color;
    }, function (props) {
      return props.theme.dante_bg_color;
    }, function (props) {
    ...
    function PlaceholderBlock(props) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper$1, {
        selected: props.selected
      }, /*#__PURE__*/React__default['default'].createElement("div", {
        className: "content"
      }, /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, {
    ...
    ReactMediaRecorder.propTypes = {
      constraints: PropTypes__default['default'].object,
      className: PropTypes__default['default'].string,
      timeSlice: PropTypes__default['default'].number,
      mimeType: PropTypes__default['default'].string,
      render: PropTypes__default['default'].func,
      onGranted: PropTypes__default['default'].func,
      onDenied: PropTypes__default['default'].func,
      onStart: PropTypes__default['default'].func,
      onStop: PropTypes__default['default'].func,
    ...
    var VideoContainer = styled__default['default'].div(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n  background: ", ";\n  padding: 0px;\n  margin-bottom: 10px;\n  //border: 1px solid ", ";\n  box-shadow: ", ";\n  border-radius: 10px;\n  position: relative;\n"])), function (props) {
    ...
    var VideoBody = styled__default['default'].div(_templateObject2$3 || (_templateObject2$3 = _taggedTemplateLiteral(["\n  padding-bottom: 20px;\n"])));
    var green = "#00ab6b";
    var red = "#e61742";
    var gray = "#bbbbbb";
    styled__default['default'].div(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n  background: ", ";\n  position: absolute;\n  height: 13px;\n  width: 13px;\n  border-radius: 50%;\n  display: inline-block;\n  position: absolute;\n  top: 58px;\n  right: 25px;\n  box-shadow: inset -1px -2px 14px 0px #841744;\n"])), function (props) {
      return props.active ? red : green;
    });
    var EditorControls = styled__default['default'].div(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n  position: absolute;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-align: center;\n  -ms-flex-pack: center;\n  //margin-top: 25px;\n  //margin-left: 17px;\n  height: 100%;\n  z-index: 10;\n  width: 100%;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  .controls-recording {\n    position: relative;\n    display: flex;\n    align-items: center;\n  }\n"])));
    var StatusBar = styled__default['default'].div(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n  z-index: 10;\n  position: absolute;\n  height: 80%;\n  width: 100%;\n  background: ", ";\n  display: ", ";\n  align-items: center;\n\n  opacity: ", ";\n"])), function (props) {
    ...
    var VideoPlayer = styled__default['default'].video(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  width: 100%;\n  background: black;\n"])));
    var SecondsLeft = styled__default['default'].div(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  //position: absolute;\n  font-size: 1rem;\n  right: 39px;\n  top: 19px;\n  font-size: 2em;\n  color: white;\n"])));
    var RecButton = styled__default['default'].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  display: inline-block;\n  cursor: pointer;\n  -webkit-transition: all 0.25s ease;\n  transition: all 0.25s ease;\n  margin: 7px 17px;\n  text-indent: 36px;\n\n  text-indent: 36px;\n  color: #d9ece5;\n  text-shadow: 0px 1px 0px #101010;\n\n  &:hover {\n    //color: ", "\n    color: #d9ece5;\n  }\n\n  &:before {\n    position: absolute;\n    width: 26px;\n    height: 26px;\n    top: 4px;\n    content: \"\";\n    border-radius: 50px;\n    background: #e80415;\n    cursor: pointer;\n    left: 4px;\n  }\n\n  &.recording {\n    &:before {\n      position: absolute;\n      width: 20px;\n      height: 20px;\n      top: 6px;\n      content: \"\";\n      border-radius: 2px;\n      background: #e80415;\n      cursor: pointer;\n      left: 7px;\n    }\n  }\n\n  &:after {\n    position: absolute;\n    width: 30px;\n    height: 30px;\n    top: 6px;\n    left: 6px;\n    content: \"\";\n    -webkit-transform: translate(-6px, -6px);\n    -ms-transform: translate(-6px, -6px);\n    -webkit-transform: translate(-6px, -6px);\n    -ms-transform: translate(-6px, -6px);\n    -webkit-transform: translate(-6px, -6px);\n    -ms-transform: translate(-6px, -6px);\n    transform: translate(-6px, -6px);\n    border-radius: 50%;\n    border: 2px solid #fff;\n    cursor: pointer;\n  }\n"])), green);
    var Button = styled__default['default'].button(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n  margin: 11px;\n  outline: none;\n  height: 37px;\n  /* margin-right: 10px; */\n  /* text-align: center; */\n  border-radius: 40px;\n  background: ", ";\n  border: 2px solid ", ";\n  color: #ffffff;\n  -webkit-letter-spacing: 1px;\n  -moz-letter-spacing: 1px;\n  -ms-letter-spacing: 1px;\n  letter-spacing: 1px;\n  text-shadow: 0;\n  cursor: pointer;\n  -webkit-transition: all 0.25s ease;\n  transition: all 0.25s ease;\n\n  font-size: 12px;\n  font-weight: bold;\n\n  cursor: pointer;\n  transition: all 0.25s ease;\n  &:hover {\n    color: white;\n    background: ", ";\n  }\n  &:active {\n    //letter-spacing: 2px;\n    letter-spacing: 2px;\n  }\n  //&:after {\n  //  content:\"SUBMIT\";\n  //}\n\n  &.onclic {\n    width: 24px !important;\n    border-color: ", ";\n    border-width: 3px;\n    font-size: 0;\n    border-left-color: ", ";\n    animation: rotating 2s 0.25s linear infinite;\n\n    &:after {\n      content: \"\";\n    }\n    &:hover {\n      color: $green;\n      background: white;\n    }\n  }\n\n  &.right {\n    float: right;\n    margin-right: 26px;\n  }\n\n  @keyframes rotating {\n    from {\n      transform: rotate(0deg);\n    }\n    to {\n      transform: rotate(360deg);\n    }\n  }\n"])), green, green, green, gray, green);

    function VideoRecorderBlock(props) {
      var file = null;
      var app = React__default['default'].useRef();
      var mediaRecorder = React__default['default'].useRef();
      var video = React__default['default'].useRef();
      ...
      var _useCountdownTimer = useCountdownTimer.useCountdownTimer({
      ...
      return /*#__PURE__*/React__default['default'].createElement(react.NodeViewWrapper, null, /*#__PURE__*/React__default['default'].createElement(VideoContainer, {
        ref: app
      }, /*#__PURE__*/React__default['default'].createElement(ReactMediaRecorder, {
        ref: mediaRecorder,
        constraints: {
          audio: {
            sampleSize: 16,
        ...
        render: function render(_ref) {
          var start = _ref.start,
              ...
              _ref.pause;
              _ref.resume;
          return /*#__PURE__*/React__default['default'].createElement("div", null, !isReadOnly() && /*#__PURE__*/React__default['default'].createElement(StatusBar, {
            contentEditable: false,
            loading: loading
          }, loading && /*#__PURE__*/React__default['default'].createElement(Loader, {
            toggle: loading,
            progress: loadingProgress
          })), /*#__PURE__*/React__default['default'].createElement(VideoBody, null, !isReadOnly() && /*#__PURE__*/React__default['default'].createElement(EditorControls, {
            contentEditable: false
          }, /*#__PURE__*/React__default['default'].createElement("div", {
            className: "controls-recording"
          }, !loading && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(RecButton, {
          ...
          }, isRunning ? "recording. (".concat(countdown / 1000, " seconds left)") : "press button to start recording", rejectedReason && /*#__PURE__*/React__default['default'].createElement("span", null, rejectedReason)), /*#__PURE__*/React__default['default'].createElement(SecondsLeft, null))), fileReady && !loading && /*#__PURE__*/React__default['default'].createElement(Button, {
            onClick: function onClick(e) {
              e.preventDefault();
              confirm();
            }
          }, "confirm recording upload ?")), /*#__PURE__*/React__default['default'].createElement(VideoPlayer, {
            autoPlay: true,
            muted: true,
            ref: video
          }), /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, {
    ...
    function Loader(_ref2) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, toggle && /*#__PURE__*/React__default['default'].createElement("div", {
        className: "image-upoader-loader",
        style: {
          width: "100%",
          textAlign: "center"
        }
      }, /*#__PURE__*/React__default['default'].createElement("p", null, progress === 100 ? "processing video..." : /*#__PURE__*/React__default['default'].createElement("span", null, /*#__PURE__*/React__default['default'].createElement("span", null, "uploading video "), Math.round(progress), "%"))));
    }
    ...
    var StyleWrapper = styled__default['default'](react.NodeViewWrapper)(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral([""])));
    function DividerBlock(props) {
      return /*#__PURE__*/React__default['default'].createElement(StyleWrapper, {
        selected: props.selected,
    ...
    var GiphyBlock$1 = styled__default['default'].div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  //position: absolute;\n  //left: 128px;\n  //bottom: 48px;\n  //z-index: 10000;\n  //height: 251px;\n  //background: white;\n  //border: 1px solid #abaaaa;\n  //border-radius: 3px;\n  //width: 223px;\n  //box-shadow: 1px 1px 1px #ece3e3;\n"])));
    var GridListOverflow = styled__default['default'].div(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n  height: 187px;\n  overflow: auto;\n"])));
    var GridList = styled__default['default'].div(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  display: flex;\n  display: flex;\n  flex-flow: row wrap;\n  margin-left: 0px;\n  width: 100%;\n  img {\n    flex: auto;\n    height: 250px;\n    min-width: 150px;\n    margin: 0 0px 8px 0;\n  }\n"])));
    var Container = styled__default['default'].div(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  padding: 10px;\n  //background: \"#ccc\";\n"])));
    var PickerBlock = styled__default['default'].div(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n  display: flex;\n  justify-content: center;\n  margin-bottom: 4px;\n\n  &:before {\n    content: \"\";\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    height: 8px;\n    background: #c4e17f;\n    background-image: -webkit-linear-gradient(\n      left,\n      #fff35c,\n      #fff35c,\n      #ff6666,\n      #ff6666,\n      #9933ff,\n      #9933ff,\n      #00ccff,\n      #00ccff,\n      #00ff99,\n      #00ff99\n    );\n    background-image: -moz-linear-gradient(\n      left,\n      #fff35c,\n      #fff35c,\n      #ff6666,\n      #ff6666,\n      #9933ff,\n      #9933ff,\n      #00ccff,\n      #00ccff,\n      #00ff99,\n      #00ff99\n    );\n    background-image: -o-linear-gradient(\n      left,\n      #fff35c,\n      #fff35c,\n      #ff6666,\n      #ff6666,\n      #9933ff,\n      #9933ff,\n      #00ccff,\n      #00ccff,\n      #00ff99,\n      #00ff99\n    );\n    background-image: linear-gradient(\n      left,\n      #fff35c,\n      #fff35c,\n      #ff6666,\n      #ff6666,\n      #9933ff,\n      #9933ff,\n      #00ccff,\n      #00ccff,\n      #00ff99,\n      #00ff99\n    );\n  }\n"])));
    ...
    var App = /*#__PURE__*/function (_React$Component) {
      ...
      function App(props) {
        ...
        _defineProperty(_assertThisInitialized(_this), "search", function (term) {
          ...
          axios__default['default'].get(link).then(function (response) {
            // handle success
            _this.setState({
      ...
      _createClass(App, [{
        ...
        value: function render() {
          ...
          return /*#__PURE__*/React__default['default'].createElement(GiphyBlock$1, null, /*#__PURE__*/React__default['default'].createElement(Container, null, /*#__PURE__*/React__default['default'].createElement(PickerBlock, null, /*#__PURE__*/React__default['default'].createElement("input", {
            ref: function ref(c) {
          ...
          })), /*#__PURE__*/React__default['default'].createElement(GridListOverflow, null, /*#__PURE__*/React__default['default'].createElement(GridList, null, this.state.gifs.map(function (o) {
    ...
    var Modal = styled__default['default'].div(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  top: 0;\n  right: 0;\n  bottom: 0;\n  left: 0;\n  z-index: 10;\n  //background-color: ", ";\n  position: fixed;\n  justify-content: center;\n  align-items: center;\n  display: flex;\n"])), function (props) {
      return props.theme.dante_control_color;
    });
    var ModalWrapper = styled__default['default'].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  padding: 1.5rem;\n  overflow: hidden;\n  max-width: 28rem;\n  margin-top: 2rem;\n  margin-bottom: 2rem;\n  display: inline-block;\n  border-radius: 0.3rem;\n  position: relative;\n  box-shadow: 1px 2px 7px 0px #27262673;\n  border: 1px solid #2f2f2f3b;\n  background-color: ", ";\n\n  input {\n    padding: 0.4em;\n    border: 1px solid #ccc;\n    width: 100%;\n  }\n"])), function (props) {
      return props.theme.dante_inversed_color;
    });
    ...
    var GiphyBlock = /*#__PURE__*/function (_React$Component) {
      ...
      _createClass(GiphyBlock, [{
        ...
        value: function render() {
          ...
          return /*#__PURE__*/React__default['default'].createElement(react.NodeViewWrapper, {
            className: "dante-giphy-wrapper"
          }, /*#__PURE__*/React__default['default'].createElement("div", {
            contentEditable: false
          }, /*#__PURE__*/React__default['default'].createElement(Modal, null, /*#__PURE__*/React__default['default'].createElement(ModalWrapper, null, /*#__PURE__*/React__default['default'].createElement("button", {
            onClick: this.selfDestroy
          }, "close"), /*#__PURE__*/React__default['default'].createElement(App, {
    ...
    var StartButton = styled__default['default'].a(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  border-radius: 50%;\n  background-color: #ff5e5e;\n  width: 50px;\n  height: 50px;\n  display: block;\n  margin: 0 auto;\n  cursor: pointer;\n  text-align: center;\n  box-shadow: ", ";\n  svg {\n    margin-top: 12px;\n    fill: white;\n    display: inline;\n    vertical-align: unset !important;\n    &:hover {\n      fill: #222;\n    }\n  }\n"])), function (props) {
      return props.recording ? "inset -1px 1px 0px 0px #270101" : "inset 0px -1px 0px 0px #270101";
    });
    var RecorderWrapper = styled__default['default'].div(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  margin: 0px auto;\n  text-align: center;\n"])));
    var RecorderLegend = styled__default['default'].span(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  color: #797878;\n  font-size: 0.789em;\n  text-transform: uppercase;\n  font-family: futura-pt;\n"])));
    var SpeechRecorderWrapper = styled__default['default'](react.NodeViewWrapper)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  background: #ccc;\n  padding: 20px;\n  background: #fdffd4;\n  padding: 21px;\n  border: 1px solid #f0f1d9;\n  position: relative;\n"])));
    var DeleteSelf = styled__default['default'].button(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  position: absolute;\n  right: 10px;\n  top: 1px;\n"])));
    ...
    var SpeechToTextBlock = /*#__PURE__*/function (_React$Component) {
      ...
      _createClass(SpeechToTextBlock, [{
        ...
        value: function render() {
          ...
          return /*#__PURE__*/React__default['default'].createElement(SpeechRecorderWrapper, null, this.props.editor.isEditable ? /*#__PURE__*/React__default['default'].createElement(DeleteSelf, {
            href: "#",
            className: "graf--media-embed-close",
            onClick: this.deleteSelf
          }, "x") : null, /*#__PURE__*/React__default['default'].createElement(RecorderWrapper, null, /*#__PURE__*/React__default['default'].createElement(StartButton, {
            id: "start_button",
          ...
          }, speech()), /*#__PURE__*/React__default['default'].createElement(RecorderLegend, null, this.state.recording ? "stop dictation" : "start dictation"), this.state.transcript.length > 0 && /*#__PURE__*/React__default['default'].createElement("div", {
            className: "d-flex justify-content-center"
          }, /*#__PURE__*/React__default['default'].createElement("button", {
            onClick: this.convert,
            className: "btn btn-success mr-1"
          }, "confirm"), /*#__PURE__*/React__default['default'].createElement("button", {
            alt: "reset",
            onClick: this.resetRecorder,
            className: "btn btn-link"
          }, "or cancel"))), /*#__PURE__*/React__default['default'].createElement(react.NodeViewContent, null, this.state.transcript.map(function (o) {
            return o;
          })));
        }
      }]);
    ...
    exports.GiphyBlock = GiphyBlock;
    exports.GiphyBlockConfig = GiphyBlockConfig;
    exports.Icons = icons;
    exports.ImageBlock = ImageBlock;
    exports.ImageBlockConfig = ImageBlockConfig;
    exports.MediaRecorder = ReactMediaRecorder;
    exports.PlaceholderBlock = PlaceholderBlock;
    exports.PlaceholderBlockConfig = PlaceholderBlockConfig;
    exports.SpeechToTextBlock = SpeechToTextBlock;
    exports.SpeechToTextBlockConfig = SpeechToTextBlockConfig;
    exports.Styled = index;
    exports.VideoBlock = VideoBlock;
    exports.VideoBlockConfig = VideoBlockConfig;
    exports.VideoRecorderBlock = VideoRecorderBlock;
